...
client.on('ready', () => console.log('Estou Pronta!'));

client.on('disconnect', () => console.log('Desconectado, até mais..'));
...
client.on('message', async msg => { // eslint-disable-line
	...
	if (command === 'play') {
		...
		if (url.match(/^https?:\/\/(www.youtube.com|youtube.com)\/playlist(.*)$/)) {
			...
			return msg.channel.send(`A Playlist: **${playlist.title}** foi adicionada a lista!`);
		} else {
			try {
